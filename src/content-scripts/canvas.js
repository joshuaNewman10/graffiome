...
var getRequestedDrawing = function(username) {
  console.log('about to request a drawing from firebase');
  chrome.runtime.sendMessage(
...
var removeRequestedDrawing = function(username) {
  console.log('about to remove requested drawing');
  var targetDrawing = $('.' + username);
